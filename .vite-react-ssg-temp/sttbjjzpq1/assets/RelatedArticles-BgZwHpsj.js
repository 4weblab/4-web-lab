...
import { A as AnimatedSection } from "../main.mjs";
...
const RelatedArticles = ({ currentSlug }) => {
  ...
  return /* @__PURE__ */ jsx("section", { className: "section-padding bg-background", children: /* @__PURE__ */ jsx("div", { className: "container-section", children: /* @__PURE__ */ jsxs(AnimatedSection, { className: "mx-auto max-w-2xl", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-10 text-center md:mb-12", children: [
      /* @__PURE__ */ jsx("div", { className: "mx-auto mb-6 h-1 w-14 rounded-full bg-accent" }),
      /* @__PURE__ */ jsx("h2", { className: "heading-2 text-foreground", children: "Continua a leggere" }),
      /* @__PURE__ */ jsx("p", { className: "body-base mt-4 text-muted-foreground", children: "Altri articoli dal blog di 4 Web Lab." })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-5", children: related.map((article) => /* @__PURE__ */ jsxs(
      "article",
      {
        ...
        children: [
          /* @__PURE__ */ jsx(Link, { to: article.path, className: "block aspect-[16/10] overflow-hidden bg-muted", children: /* @__PURE__ */ jsx(
            "img",
            {
              src: article.image,
              alt: article.alt,
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col p-4 md:p-5", children: [
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-semibold uppercase tracking-wider text-accent", children: article.category }),
            /* @__PURE__ */ jsx("h3", { className: "mt-2 text-sm font-semibold leading-snug text-foreground md:text-base", children: /* @__PURE__ */ jsx(Link, { to: article.path, className: "hover:text-accent transition-colors", children: article.title }) }),
            /* @__PURE__ */ jsx("p", { className: "mt-2 text-xs leading-relaxed line-clamp-2 text-muted-foreground", children: article.excerpt }),
            /* @__PURE__ */ jsx("div", { className: "mt-3 pt-3 border-t border-border/50", children: /* @__PURE__ */ jsxs(
              Link,
              {
                to: article.path,
