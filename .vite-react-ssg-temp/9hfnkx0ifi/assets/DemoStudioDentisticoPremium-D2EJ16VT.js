...
import { W, m as motion } from "../main.mjs";
  ...
  return /* @__PURE__ */ jsxs(
    "header",
    {
      ...
      children: [
          ...
          /* @__PURE__ */ jsxs(
            "a",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("span", { className: "font-semibold text-[1.05rem] tracking-[0.04em]", style: { color: C.ink }, children: [
                  "Aurea",
        ...
        open && /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-[60] flex flex-col", style: { background: C.bg }, children: [
          /* @__PURE__ */ jsxs("div", { className: "px-5 h-16 flex items-center justify-between border-b", style: { borderColor: C.border }, children: [
            /* @__PURE__ */ jsx("span", { className: "font-semibold tracking-[0.04em]", style: { color: C.ink }, children: "Aurea." }),
            /* @__PURE__ */ jsx("button", { onClick: () => setOpen(false), "aria-label": "Chiudi menu", style: { color: C.ink }, className: "p-2", children: /* @__PURE__ */ jsx(X, { className: "w-6 h-6" }) })
          ] }),
          /* @__PURE__ */ jsxs("nav", { className: "flex-1 flex flex-col justify-center px-8 gap-1", "aria-label": "Menu mobile", children: [
            navItems.map((it, i) => /* @__PURE__ */ jsx(
              "a",
              {
                href: it.href,
                onClick: (e) => {
...
const Hero = () => /* @__PURE__ */ jsxs(
  "section",
  {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("div", { "aria-hidden": true, className: "absolute inset-0 opacity-[0.4]", style: {
        backgroundImage: `radial-gradient(circle at 1px 1px, ${C.ink}11 1px, transparent 0)`,
        backgroundSize: "32px 32px",
        maskImage: "radial-gradient(ellipse at center, black 30%, transparent 70%)"
      } }),
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 max-w-7xl mx-auto px-5 md:px-8 pt-32 pb-20 md:pt-40 md:pb-24 w-full grid lg:grid-cols-[1.05fr_0.95fr] gap-12 lg:gap-16 items-center", children: [
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs(
                "span",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 rounded-full", style: { background: C.cyan, boxShadow: `0 0 12px ${C.cyan}` } }),
              ...
              /* @__PURE__ */ jsx("h2", { className: "sr-only", children: "Sito web per studio dentistico — concept realizzato da 4 Web Lab, agenzia web di Padova specializzata in siti per professionisti" }),
              /* @__PURE__ */ jsx("p", { className: "text-lg md:text-xl max-w-2xl mb-10 leading-relaxed", style: { color: C.textDim }, children: "Odontoiatria di precisione e estetica dentale con tecnologia digitale 3D. Un percorso personalizzato, in un ambiente progettato attorno alla tua serenità." }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-x-8 gap-y-4", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5", children: [
                  /* @__PURE__ */ jsx("div", { className: "flex", children: [0, 1, 2, 3, 4].map((i) => /* @__PURE__ */ jsx(Star, { className: "w-4 h-4 fill-current", style: { color: "#F5B301" } }, i)) }),
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-medium", style: { color: C.ink }, children: "4.9/5 · 320+ recensioni" })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm", style: { color: C.textDim }, children: [
                  /* @__PURE__ */ jsx(ShieldCheck, { className: "w-4 h-4", style: { color: C.cyan } }),
            ...
            children: [
                  ...
                  children: [
                    /* @__PURE__ */ jsx(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsx(Users, { className: "w-5 h-5 text-white" })
                      }
                    ),
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("div", { className: "text-[18px] font-semibold leading-none", style: { color: C.ink }, children: "+2.500" }),
                      /* @__PURE__ */ jsx("div", { className: "text-[11px] mt-1", style: { color: C.textDim }, children: "pazienti seguiti" })
                    ] })
                  ]
                }
              ),
                  ...
                  children: [
                    /* @__PURE__ */ jsx(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsx(ScanLine, { className: "w-5 h-5", style: { color: C.primary } })
                      }
                    ),
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("div", { className: "text-[14px] font-semibold leading-none", style: { color: C.ink }, children: "Tecnologia 3D" }),
                      /* @__PURE__ */ jsx("div", { className: "text-[11px] mt-1", style: { color: C.textDim }, children: "Scansione intraorale" })
                    ] })
                  ]
                }
              ),
              /* @__PURE__ */ jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("span", { className: "w-2 h-2 rounded-full animate-pulse", style: { background: C.cyan } }),
                    /* @__PURE__ */ jsx("span", { className: "text-[13px] font-semibold", style: { color: C.ink }, children: "Prima visita dedicata · 60 min" })
                  ]
                }
              )
            ]
...
const DemoNotice = () => /* @__PURE__ */ jsx("section", { className: "py-10 md:py-14", style: { background: C.bg }, children: /* @__PURE__ */ jsx("div", { className: "max-w-5xl mx-auto px-5 md:px-8", children: /* @__PURE__ */ jsxs(
  "div",
  {
    ...
    children: [
      /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsx(Sparkles, { className: "w-5 h-5", style: { color: C.primary } })
        }
      ),
      /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsx("div", { className: "text-[11px] font-semibold uppercase tracking-[0.18em] mb-1", style: { color: C.primary }, children: "Concept project · Tech demo" }),
        /* @__PURE__ */ jsxs("p", { className: "text-[14.5px] leading-relaxed", style: { color: C.inkSoft }, children: [
          "Questa pagina è una ",
          /* @__PURE__ */ jsx("strong", { children: "demo concettuale realizzata da 4 Web Lab" }),
...
const SectionHead = ({
  ...
  light = false,
  center = false
}) => /* @__PURE__ */ jsxs("div", { className: `max-w-3xl ${center ? "mx-auto text-center" : ""} mb-14 md:mb-20`, children: [
  /* @__PURE__ */ jsx(
    "span",
    {
  ...
  sub && /* @__PURE__ */ jsx("p", { className: "text-base md:text-lg leading-relaxed", style: { color: light ? "rgba(255,255,255,0.78)" : C.textDim }, children: sub })
] });
const Trust = () => {
  const items = [
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-16 md:py-20", style: { background: C.bg }, children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-5 md:px-8", children: /* @__PURE__ */ jsx(
    "div",
    {
      className: "grid grid-cols-2 md:grid-cols-4 gap-px rounded-2xl overflow-hidden",
      style: { background: C.border },
      children: items.map((it) => /* @__PURE__ */ jsxs("div", { className: "px-6 py-7 md:py-9 text-center", style: { background: C.bgSoft }, children: [
        /* @__PURE__ */ jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsx("div", { className: "text-[12px] uppercase tracking-wider", style: { color: C.textDim }, children: it.l })
      ] }, it.l))
    }
  ) }) });
};
const Studio = () => /* @__PURE__ */ jsx("section", { id: "studio", className: "py-24 md:py-32 relative overflow-hidden", style: { background: C.bg }, children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-5 md:px-8 grid lg:grid-cols-2 gap-14 lg:gap-20 items-center", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
            /* @__PURE__ */ jsx(Award, { className: "w-4 h-4", style: { color: C.beige } }),
            /* @__PURE__ */ jsx("span", { className: "text-[11px] font-semibold uppercase tracking-wider", style: { color: C.inkSoft }, children: "Filosofia" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-[13.5px] leading-relaxed", style: { color: C.ink }, children: '"Ogni sorriso è una storia. Il nostro compito è prendercene cura come fosse la nostra."' })
        ]
      }
    )
  ] }),
  /* @__PURE__ */ jsxs("div", { className: "order-1 lg:order-2", children: [
    /* @__PURE__ */ jsx(
      SectionHead,
      {
        ...
        title: /* @__PURE__ */ jsxs(Fragment, { children: [
          "Un approccio ",
          /* @__PURE__ */ jsx("em", { style: { color: C.primary, fontStyle: "italic" }, children: "su misura" }),
    ...
    ].map((p) => /* @__PURE__ */ jsxs("li", { className: "flex gap-3 text-[15px]", style: { color: C.ink }, children: [
      /* @__PURE__ */ jsx(CheckCircle2, { className: "w-5 h-5 flex-shrink-0 mt-0.5", style: { color: C.cyan } }),
      p
    ] }, p)) })
  ] })
] }) });
const Trattamenti = () => {
  ...
  return /* @__PURE__ */ jsx("section", { id: "trattamenti", className: "py-24 md:py-32 relative", style: { background: C.bgSoft }, children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-5 md:px-8", children: [
    /* @__PURE__ */ jsx(
      SectionHead,
      {
        kicker: "Trattamenti",
        title: /* @__PURE__ */ jsxs(Fragment, { children: [
          "Ogni servizio è un ",
          /* @__PURE__ */ jsx("em", { style: { color: C.primary, fontStyle: "italic" }, children: "percorso" }),
    ...
    /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5", children: items.map((it, i) => /* @__PURE__ */ jsxs(
      motion.article,
      {
        initial: { opacity: 0, y: 24 },
        ...
        children: [
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx(it.icon, { className: "w-5 h-5", style: { color: C.primary } })
            }
          ),
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold mb-2", style: { color: C.ink }, children: it.title }),
          /* @__PURE__ */ jsx("p", { className: "text-[14.5px] leading-relaxed mb-5", style: { color: C.textDim }, children: it.desc }),
          /* @__PURE__ */ jsxs(
            "button",
            {
              onClick: scrollToContact,
              ...
              children: [
                ...
                /* @__PURE__ */ jsx(ArrowRight, { className: "w-3.5 h-3.5 transition-transform group-hover:translate-x-1" })
              ]
            }
          )
        ]
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative max-w-7xl mx-auto px-5 md:px-8 grid lg:grid-cols-2 gap-14 lg:gap-20 items-center", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(
              SectionHead,
              {
                ...
                title: /* @__PURE__ */ jsxs(Fragment, { children: [
                  ...
                  /* @__PURE__ */ jsx("em", { style: { color: C.cyan, fontStyle: "italic" }, children: "prima" }),
                  " di iniziare."
                ] }),
            ...
            /* @__PURE__ */ jsx("div", { className: "space-y-4", children: phases.map((p, i) => /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("h3", { className: "text-[15px] font-semibold mb-1", style: { color: "#fff" }, children: p.t }),
                    /* @__PURE__ */ jsx("p", { className: "text-[13.5px] leading-relaxed", style: { color: "rgba(255,255,255,0.7)" }, children: p.d })
                  ] })
                ]
              },
              p.n
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx("span", { className: "w-2 h-2 rounded-full animate-pulse", style: { background: C.cyan } }),
                      /* @__PURE__ */ jsx("span", { className: "text-[12px] font-semibold tracking-wide", style: { color: "#fff" }, children: "SCAN ATTIVA" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx("div", { className: "text-[10px] uppercase tracking-wider mb-0.5", style: { color: C.textDim }, children: "Anteprima trattamento" }),
                      /* @__PURE__ */ jsx("div", { className: "text-[13px] font-semibold", style: { color: C.ink }, children: "Allineamento + faccette · 14 mesi" })
                    ]
                  }
                )
              ]
...
const BeforeAfter = () => {
  ...
  return /* @__PURE__ */ jsx("section", { id: "risultati", className: "py-24 md:py-32", style: { background: C.bg }, children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-5 md:px-8", children: [
    /* @__PURE__ */ jsx(
      SectionHead,
      {
        ...
        title: /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsx("em", { style: { color: C.primary, fontStyle: "italic" }, children: "millimetro dopo millimetro" }),
          "."
        ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "absolute top-0 bottom-0 pointer-events-none", style: { left: `${pos}%`, width: 2, background: "#fff", boxShadow: "0 0 20px rgba(0,0,0,0.4)" } }),
            /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx(ArrowLeft, { className: "w-3.5 h-3.5", style: { color: C.primary } }),
                  /* @__PURE__ */ jsx(ArrowRight, { className: "w-3.5 h-3.5 -ml-1", style: { color: C.primary } })
                ]
              }
            )
          ]
      ...
      /* @__PURE__ */ jsx("p", { className: "text-center text-sm mt-6", style: { color: C.textDim }, children: "Caso clinico dimostrativo · Le immagini di paragone sono a scopo illustrativo." })
    ] })
  ] }) });
};
const Reviews = () => {
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-24 md:py-32", style: { background: C.bgSoft }, children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-5 md:px-8", children: [
    /* @__PURE__ */ jsx(
      SectionHead,
      {
        kicker: "Recensioni",
        title: /* @__PURE__ */ jsxs(Fragment, { children: [
          "La parola ai nostri ",
          /* @__PURE__ */ jsx("em", { style: { color: C.primary, fontStyle: "italic" }, children: "pazienti" }),
          "."
        ] }),
    ...
    /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 gap-6", children: items.map((r, i) => /* @__PURE__ */ jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 24 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: "flex items-center gap-1 mb-4", children: [0, 1, 2, 3, 4].map((s) => /* @__PURE__ */ jsx(Star, { className: "w-4 h-4 fill-current", style: { color: "#F5B301" } }, s)) }),
          /* @__PURE__ */ jsxs("p", { className: "text-[15px] leading-relaxed mb-6 flex-1", style: { color: C.ink }, children: [
            '"',
            r.t,
            '"'
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 pt-5 border-t", style: { borderColor: C.border }, children: [
            /* @__PURE__ */ jsx(
              "img",
              {
                src: r.img,
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { className: "text-[14px] font-semibold", style: { color: C.ink }, children: r.n }),
              /* @__PURE__ */ jsx("div", { className: "text-[12px]", style: { color: C.textDim }, children: r.role })
            ] })
          ] })
        ]
      },
    ...
    /* @__PURE__ */ jsx("p", { className: "text-center text-xs mt-8", style: { color: C.textDim }, children: "Recensioni illustrative create per la demo. Nessun dato reale è stato utilizzato." })
  ] }) });
};
const Team = () => {
  const team = [
  ...
  return /* @__PURE__ */ jsx("section", { id: "team", className: "py-24 md:py-32", style: { background: C.bg }, children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-5 md:px-8", children: [
    /* @__PURE__ */ jsx(
      SectionHead,
      {
        kicker: "Il team",
        title: /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsx("em", { style: { color: C.primary, fontStyle: "italic" }, children: "professionisti" }),
          "."
        ] }),
    ...
    /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8", children: team.map((m, i) => /* @__PURE__ */ jsxs(
      motion.figure,
      {
        initial: { opacity: 0, y: 24 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("figcaption", { className: "p-6", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold mb-1", style: { color: C.ink }, children: m.n }),
            /* @__PURE__ */ jsx("div", { className: "text-[13px]", style: { color: C.textDim }, children: m.role })
          ] })
        ]
      },
      m.n
    ...
    /* @__PURE__ */ jsx(
      SectionHead,
      {
        ...
        title: /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsx("em", { style: { color: C.primary, fontStyle: "italic" }, children: "parte della cura" }),
          "."
        ] }),
    ...
    /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5", children: items.map((it, i) => /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("h3", { className: "text-base font-semibold mb-2", style: { color: C.ink }, children: it.t }),
          /* @__PURE__ */ jsx("p", { className: "text-[14px] leading-relaxed", style: { color: C.textDim }, children: it.d })
        ]
      },
      it.t
    )) })
...
const FAQ = () => {
  ...
  return /* @__PURE__ */ jsx("section", { id: "faq", className: "py-24 md:py-32", style: { background: C.bg }, children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto px-5 md:px-8", children: [
    /* @__PURE__ */ jsx(
      SectionHead,
      {
        ...
        title: /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsx("em", { style: { color: C.primary, fontStyle: "italic" }, children: "comuni" }),
          "."
        ] }),
        center: true
      }
    ),
    /* @__PURE__ */ jsx("div", { className: "space-y-3", children: items.map((it, i) => {
      const isOpen = open === i;
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("span", { className: "flex-1 text-[15px] md:text-base font-semibold", style: { color: C.ink }, children: it.q }),
                  /* @__PURE__ */ jsx(
                    "span",
                    {
                      ...
                      children: isOpen ? /* @__PURE__ */ jsx(Minus, { className: "w-4 h-4" }) : /* @__PURE__ */ jsx(Plus, { className: "w-4 h-4" })
                    }
                  )
                ]
              }
            ),
            isOpen && /* @__PURE__ */ jsx("div", { className: "px-6 pb-6 text-[14.5px] leading-relaxed", style: { color: C.textDim }, children: it.a })
          ]
        },
        it.q
      );
...
const BookingForm = () => {
  ...
  return /* @__PURE__ */ jsxs("form", { ref: formRef, onSubmit, noValidate: true, className: "space-y-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: labelCls, style: { color: C.inkSoft }, children: "Nome e cognome *" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            "data-field": "name",
        ...
        errors.name && /* @__PURE__ */ jsx("span", { className: "text-xs mt-1 block text-red-500", children: errors.name })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: labelCls, style: { color: C.inkSoft }, children: "Telefono *" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            "data-field": "phone",
        ...
        errors.phone && /* @__PURE__ */ jsx("span", { className: "text-xs mt-1 block text-red-500", children: errors.phone })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: labelCls, style: { color: C.inkSoft }, children: "Email *" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            "data-field": "email",
        ...
        errors.email && /* @__PURE__ */ jsx("span", { className: "text-xs mt-1 block text-red-500", children: errors.email })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: labelCls, style: { color: C.inkSoft }, children: "Trattamento di interesse" }),
        /* @__PURE__ */ jsxs("select", { name: "trattamento", className: inputBase, style: inputStyle(), defaultValue: "", children: [
          /* @__PURE__ */ jsx("option", { value: "", children: "Seleziona…" }),
          /* @__PURE__ */ jsx("option", { children: "Prima visita" }),
          /* @__PURE__ */ jsx("option", { children: "Igiene professionale" }),
          /* @__PURE__ */ jsx("option", { children: "Implantologia" }),
          /* @__PURE__ */ jsx("option", { children: "Invisalign" }),
          /* @__PURE__ */ jsx("option", { children: "Estetica dentale / Faccette" }),
          /* @__PURE__ */ jsx("option", { children: "Sbiancamento" }),
          /* @__PURE__ */ jsx("option", { children: "Altro" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("label", { className: labelCls, style: { color: C.inkSoft }, children: "Messaggio" }),
      /* @__PURE__ */ jsx(
        "textarea",
        {
          name: "message",
    ...
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          ...
          status.state !== "sending" && /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4" })
        ]
      }
    ),
    ...
    /* @__PURE__ */ jsxs("p", { className: "text-[11.5px] leading-relaxed mt-2", style: { color: C.textDim }, children: [
      ...
      " ",
      /* @__PURE__ */ jsx(Link, { to: "/privacy", target: "_blank", className: "underline", style: { color: C.primary }, children: "Privacy Policy" }),
      "."
    ] })
  ] });
};
const Booking = () => /* @__PURE__ */ jsx("section", { id: "prenota", className: "py-24 md:py-32", style: { background: C.bgSoft }, children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-5 md:px-8", children: [
  /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx(AlertTriangle, { className: "w-5 h-5" })
          }
        ),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "text-[11px] font-bold uppercase tracking-[0.2em] mb-1", style: { color: C.primary }, children: "Avviso importante — Tech Demo" }),
          /* @__PURE__ */ jsxs("p", { className: "text-[14.5px] leading-relaxed", style: { color: C.ink }, children: [
            "Questa è una ",
            /* @__PURE__ */ jsx("strong", { children: "demo concettuale realizzata da 4 Web Lab" }),
            ". Le richieste inviate tramite questo modulo verranno recapitate ",
            /* @__PURE__ */ jsx("strong", { children: "direttamente a 4 Web Lab" }),
            " e ",
            /* @__PURE__ */ jsx("strong", { children: "non" }),
  ...
  /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-[0.95fr_1.05fr] gap-10 lg:gap-16", children: [
      ...
      /* @__PURE__ */ jsx(
        SectionHead,
        {
          ...
          title: /* @__PURE__ */ jsxs(Fragment, { children: [
            ...
            /* @__PURE__ */ jsx("em", { style: { color: C.primary, fontStyle: "italic" }, children: "primo passo" }),
            "."
          ] }),
          ...
          "a",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsx("div", { className: "text-[11px] uppercase tracking-wider", style: { color: C.textDim }, children: "Chiama lo studio" }),
                /* @__PURE__ */ jsx("div", { className: "font-semibold", style: { color: C.ink }, children: "+39 351 465 6042" })
              ] }),
              /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4 transition-transform group-hover:translate-x-1", style: { color: C.primary } })
            ]
          }
        ),
        /* @__PURE__ */ jsxs(
            ...
            children: [
              /* @__PURE__ */ jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsx("svg", { viewBox: "0 0 24 24", className: "w-5 h-5", fill: "currentColor", "aria-hidden": true, children: /* @__PURE__ */ jsx("path", { d: "M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347zM12.05 21.785h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884zm8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893A11.821 11.821 0 0020.463 3.488z" }) })
                }
              ),
              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsx("div", { className: "text-[11px] uppercase tracking-wider", style: { color: C.textDim }, children: "WhatsApp (più rapido)" }),
                /* @__PURE__ */ jsx("div", { className: "font-semibold", style: { color: C.ink }, children: "Scrivici su WhatsApp" })
              ] }),
              /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4 transition-transform group-hover:translate-x-1", style: { color: "#25D366" } })
            ]
          }
        ),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 p-4 rounded-2xl", style: { background: "#fff", border: `1px solid ${C.border}` }, children: [
          /* @__PURE__ */ jsx(
            "div",
            {
              className: "w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0",
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsx("div", { className: "text-[11px] uppercase tracking-wider", style: { color: C.textDim }, children: "Orari (placeholder)" }),
            /* @__PURE__ */ jsx("div", { className: "font-semibold text-[14px]", style: { color: C.ink }, children: "Lun-Ven 9:00 — 19:30 · Sab 9:00 — 13:00" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 p-4 rounded-2xl", style: { background: "#fff", border: `1px solid ${C.border}` }, children: [
          /* @__PURE__ */ jsx(
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsx("div", { className: "text-[11px] uppercase tracking-wider", style: { color: C.textDim }, children: "Sede (placeholder)" }),
            /* @__PURE__ */ jsx("div", { className: "font-semibold text-[14px]", style: { color: C.ink }, children: "Via Demo del Sorriso 12 — Milano" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-3 pt-6 border-t", style: { borderColor: C.border }, children: [
        { v: "24h", l: "Risposta" },
        { v: "60'", l: "Prima visita" },
        { v: "0€", l: "Senza impegno" }
      ].map((b) => /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsx("div", { className: "font-semibold text-xl", style: { color: C.ink, fontFamily: "ui-serif, serif" }, children: b.v }),
        /* @__PURE__ */ jsx("div", { className: "text-[10px] uppercase tracking-wider mt-1", style: { color: C.textDim }, children: b.l })
      ] }, b.l)) })
    ] }),
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-5", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold", style: { color: C.ink, fontFamily: "ui-serif, serif" }, children: "Modulo prenotazione" }),
            /* @__PURE__ */ jsx(
              "span",
              {
...
const AureaFooter = () => /* @__PURE__ */ jsx("footer", { className: "pt-16 pb-8", style: { background: C.ink, color: "rgba(255,255,255,0.7)" }, children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-5 md:px-8", children: [
  /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-4 gap-10 mb-10", children: [
    /* @__PURE__ */ jsxs("div", { className: "md:col-span-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5 mb-4", children: [
        ...
        /* @__PURE__ */ jsxs("span", { className: "font-semibold tracking-[0.04em] text-white", children: [
          "Aurea",
          /* @__PURE__ */ jsx("span", { style: { color: C.cyan }, children: "." })
        ] })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-[14px] leading-relaxed mb-5 max-w-md italic", style: { color: "rgba(255,255,255,0.6)" }, children: '"Un nuovo standard per il tuo sorriso."' }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-2 text-[13.5px]", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx(MapPin, { className: "w-4 h-4 mt-0.5 flex-shrink-0", style: { color: C.cyan } }),
          "Via Demo del Sorriso 12 — 20121 Milano (placeholder)"
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx(Phone, { className: "w-4 h-4 mt-0.5 flex-shrink-0", style: { color: C.cyan } }),
          "02 1234 5678 (placeholder)"
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx(Mail, { className: "w-4 h-4 mt-0.5 flex-shrink-0", style: { color: C.cyan } }),
          "info@studio-aurea.demo"
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx(Clock, { className: "w-4 h-4 mt-0.5 flex-shrink-0", style: { color: C.cyan } }),
          "Lun-Ven 9:00 — 19:30 · Sab 9:00 — 13:00"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("h4", { className: "text-[11px] font-semibold uppercase tracking-[0.2em] mb-4 text-white", children: "Studio" }),
      /* @__PURE__ */ jsx("ul", { className: "space-y-2 text-[13.5px]", children: navItems.map((it) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(
        "a",
        {
          href: it.href,
          onClick: (e) => {
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("h4", { className: "text-[11px] font-semibold uppercase tracking-[0.2em] mb-4 text-white", children: "Seguici" }),
      /* @__PURE__ */ jsx("div", { className: "flex gap-2 mb-5", children: ["Instagram", "Facebook", "LinkedIn"].map((s) => /* @__PURE__ */ jsx(
        "a",
        {
          href: "#",
          "aria-label": s,
  ...
  /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("strong", { className: "text-white", children: "Nota:" }),
        ' Studio Dentistico "Aurea" è un brand fittizio creato esclusivamente per finalità dimostrative. Questa pagina è una ',
        /* @__PURE__ */ jsx("strong", { className: "text-white", children: "tech demo" }),
        " sviluppata da ",
        /* @__PURE__ */ jsx(Link, { to: "/", className: "underline", style: { color: C.cyan }, children: "4 Web Lab" }),
  ...
  /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { children: "© 2026 Studio Dentistico Aurea (demo) — Tutti i diritti riservati." }),
        /* @__PURE__ */ jsxs("div", { children: [
          "Tech demo by",
          " ",
          /* @__PURE__ */ jsx(Link, { to: "/", className: "font-semibold text-white", children: "4 Web Lab" }),
          " ·",
          " ",
          /* @__PURE__ */ jsx(Link, { to: "/privacy", className: "hover:text-white", children: "Privacy" }),
          " ·",
          " ",
          /* @__PURE__ */ jsx(Link, { to: "/cookie", className: "hover:text-white", children: "Cookie" })
        ] })
      ]
    }
  )
] }) });
const MobileSticky = () => /* @__PURE__ */ jsxs("div", { className: "lg:hidden fixed bottom-4 inset-x-4 z-40 flex gap-2", children: [
  /* @__PURE__ */ jsxs(
    "a",
    {
      href: "tel:+393514656042",
...
const DemoStudioDentisticoPremium = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(W, { children: [
      /* @__PURE__ */ jsx("title", { children: "Sito Web per Studio Dentistico · Demo Padova | 4 Web Lab" }),
      /* @__PURE__ */ jsx(
        "meta",
        {
          name: "description",
      ...
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: "Sito Web per Studio Dentistico · Demo Padova | 4 Web Lab" }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: "Demo di sito web per studi dentistici e professionisti sanitari · 4 Web Lab, agenzia web di Padova. Da 549€." }),
      /* @__PURE__ */ jsx("meta", { property: "og:url", content: canonical }),
      /* @__PURE__ */ jsx("meta", { property: "og:image", content: "https://4weblab.it/og/demo-studio-dentistico-premium.webp" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:card", content: "summary_large_image" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:title", content: "Sito Web per Studio Dentistico · Demo Padova | 4 Web Lab" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:description", content: "Demo di sito web per studi dentistici · 4 Web Lab, agenzia web di Padova. Da 549€." }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:image", content: "https://4weblab.it/og/demo-studio-dentistico-premium.webp" }),
    ...
    /* @__PURE__ */ jsxs("div", { style: { background: C.bg, color: C.ink, fontFamily: "system-ui, -apple-system, 'Segoe UI', sans-serif" }, children: [
      /* @__PURE__ */ jsx(AureaHeader, {}),
      /* @__PURE__ */ jsxs("main", { children: [
        /* @__PURE__ */ jsx(Hero, {}),
        /* @__PURE__ */ jsx(DemoNotice, {}),
        /* @__PURE__ */ jsx(Trust, {}),
        /* @__PURE__ */ jsx(Studio, {}),
        /* @__PURE__ */ jsx(Trattamenti, {}),
        /* @__PURE__ */ jsx(DSD, {}),
      ...
      /* @__PURE__ */ jsx(AureaFooter, {}),
      /* @__PURE__ */ jsx(MobileSticky, {})
    ] })
  ] });
};
export {
