    ...
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-5 md:px-8 h-16 md:h-20 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs(
            "a",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "font-semibold text-[1.05rem] tracking-[0.18em]", style: { color: C.text }, children: "AURUM" })
              ]
            }
          ),
          ...
          /* @__PURE__ */ jsx("div", { className: "hidden lg:flex items-center gap-3", children: /* @__PURE__ */ jsxs(
            "button",
            {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "px-5 h-16 flex items-center justify-between border-b", style: { borderColor: C.border }, children: [
                /* @__PURE__ */ jsx("span", { className: "font-semibold tracking-[0.18em]", style: { color: C.text }, children: "AURUM" }),
                /* @__PURE__ */ jsx("button", { onClick: () => setOpen(false), "aria-label": "Chiudi menu", style: { color: C.text }, className: "p-2", children: /* @__PURE__ */ jsx(X, { className: "w-6 h-6" }) })
              ] }),
...
const Hero = () => /* @__PURE__ */ jsxs("section", { id: "top", className: "relative min-h-[100svh] flex items-center overflow-hidden", style: { background: C.bg }, children: [
  ...
  /* @__PURE__ */ jsx("div", { "aria-hidden": true, className: "absolute inset-0 opacity-[0.07]", style: {
  ...
  /* @__PURE__ */ jsx("div", { className: "relative z-10 max-w-7xl mx-auto px-5 md:px-8 pt-32 pb-20 md:pt-40 md:pb-24 w-full", children: /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 rounded-full", style: { background: C.accent, boxShadow: `0 0 12px ${C.accent}` } }),
          ...
          "h1",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("span", { style: {
                ...
                backgroundClip: "text"
              }, children: "d'Avanguardia" })
            ]
          }
        ),
        /* @__PURE__ */ jsx("h2", { className: "sr-only", children: "Sito web per azienda metalmeccanica — concept realizzato da 4 Web Lab, agenzia web di Padova" }),
        /* @__PURE__ */ jsx("p", { className: "text-lg md:text-xl max-w-2xl mb-10 leading-relaxed", style: { color: C.textDim }, children: "Dal prototipo alla produzione in serie, trasformiamo il metallo in soluzioni ingegneristiche ad alte prestazioni per industria, automazione e meccanica di precisione." }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-3 mb-14", children: [
          /* @__PURE__ */ jsxs(
            "button",
            {
              onClick: scrollToContact,
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-5 md:gap-8 max-w-2xl pt-8 border-t", style: { borderColor: C.border }, children: [
          { v: "±0.02 mm", l: "Tolleranza tipica" },
          { v: "ISO 9001", l: "Sistema Qualità" },
          { v: "24/7", l: "Produzione continua" }
        ].map((s) => /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "font-mono text-xl md:text-2xl font-bold mb-1", style: { color: C.text }, children: s.v }),
          /* @__PURE__ */ jsx("div", { className: "text-[11px] uppercase tracking-wider", style: { color: C.textDim }, children: s.l })
        ] }, s.l)) })
      ]
    }
  ) }),
  /* @__PURE__ */ jsx("div", { "aria-hidden": true, className: "hidden md:block absolute right-8 top-1/2 -translate-y-1/2 z-10", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-3 items-end", children: Array.from({ length: 10 }).map((_, i) => /* @__PURE__ */ jsx("span", { className: "block h-px", style: {
    width: i % 3 === 0 ? 28 : 14,
    background: i === 5 ? C.accent : C.borderStrong
  } }, i)) }) })
] });
const SectionHead = ({ kicker, title, sub }) => /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mb-14 md:mb-20", children: [
  /* @__PURE__ */ jsxs(
    "span",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("span", { className: "absolute left-0 top-1/2 -translate-y-1/2 w-2.5 h-px", style: { background: C.accent } }),
        kicker
      ]
    }
  ),
  /* @__PURE__ */ jsx("h2", { className: "text-3xl md:text-5xl font-bold leading-[1.1] tracking-tight mb-5", style: { color: C.text, letterSpacing: "-0.015em" }, children: title }),
  sub && /* @__PURE__ */ jsx("p", { className: "text-base md:text-lg leading-relaxed", style: { color: C.textDim }, children: sub })
] });
const Values = () => {
  const items = [
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-24 md:py-32 relative", style: { background: C.bg }, children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-5 md:px-8", children: /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 gap-5", children: items.map((it, i) => /* @__PURE__ */ jsxs(
    motion.div,
    {
      initial: { opacity: 0, y: 24 },
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold mb-3", style: { color: C.text }, children: it.title }),
        /* @__PURE__ */ jsx("p", { className: "text-sm leading-relaxed", style: { color: C.textDim }, children: it.desc }),
        /* @__PURE__ */ jsxs("div", { "aria-hidden": true, className: "absolute top-4 right-4 font-mono text-xs opacity-30", style: { color: C.accent }, children: [
          "0",
          i + 1
        ] })
      ]
...
const About = () => /* @__PURE__ */ jsxs("section", { id: "azienda", className: "py-24 md:py-36 relative overflow-hidden", style: { background: C.bg2 }, children: [
  /* @__PURE__ */ jsx("div", { "aria-hidden": true, className: "absolute inset-0 opacity-[0.04]", style: {
    backgroundImage: `linear-gradient(${C.text} 1px, transparent 1px), linear-gradient(90deg, ${C.text} 1px, transparent 1px)`,
  ...
  /* @__PURE__ */ jsxs("div", { className: "relative max-w-7xl mx-auto px-5 md:px-8 grid lg:grid-cols-2 gap-14 lg:gap-20 items-center", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(
        SectionHead,
        {
          ...
          title: /* @__PURE__ */ jsxs(Fragment, { children: [
            "Venticinque anni di ",
            /* @__PURE__ */ jsx("span", { style: { color: C.accent }, children: "metallo" }),
      ...
      /* @__PURE__ */ jsx("ul", { className: "space-y-4 mb-10", children: [
      ...
      ].map((p) => /* @__PURE__ */ jsxs("li", { className: "flex gap-3 text-[15px]", style: { color: C.text }, children: [
        /* @__PURE__ */ jsx(CheckCircle2, { className: "w-5 h-5 flex-shrink-0 mt-0.5", style: { color: C.accent } }),
        p
      ] }, p)) }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-5 pt-8 border-t", style: { borderColor: C.border }, children: [
        { v: "25+", l: "Anni di esperienza" },
        { v: "1.200", l: "mq produttivi" },
        { v: "500+", l: "Commesse / anno" },
        { v: "CAD/CAM", l: "Engineering interno" }
      ].map((s) => /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "font-mono text-2xl md:text-3xl font-bold", style: { color: C.text }, children: s.v }),
        /* @__PURE__ */ jsx("div", { className: "text-[11px] uppercase tracking-wider mt-1", style: { color: C.textDim }, children: s.l })
      ] }, s.l)) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxs("div", { className: "relative rounded-2xl overflow-hidden aspect-[4/5]", style: { border: `1px solid ${C.border}` }, children: [
        /* @__PURE__ */ jsx(
          "img",
          {
            src: factoryImg,
      ...
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("div", { className: "text-xs uppercase tracking-wider mb-1", style: { color: C.textDim }, children: "Sede operativa" }),
            /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold", style: { color: C.text }, children: "Erbusco (BS) — Italy" })
          ]
        }
      ),
      /* @__PURE__ */ jsx(
...
const Technologies = () => {
  ...
  return /* @__PURE__ */ jsx("section", { id: "tecnologie", className: "py-24 md:py-36 relative", style: { background: C.bg }, children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-5 md:px-8", children: [
    /* @__PURE__ */ jsx(
      SectionHead,
      {
        kicker: "Tecnologie",
        title: /* @__PURE__ */ jsxs(Fragment, { children: [
          "Macchine, processi e ",
          /* @__PURE__ */ jsx("span", { style: { color: C.accent }, children: "controllo numerico" })
        ] }),
    ...
    /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6", children: techs.map((t, i) => /* @__PURE__ */ jsxs(
      motion.article,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 p-6 md:p-7 flex flex-col justify-end", children: [
            /* @__PURE__ */ jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsx(t.icon, { className: "w-4.5 h-4.5" })
              }
            ),
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold mb-2", style: { color: C.text }, children: t.title }),
            /* @__PURE__ */ jsx("p", { className: "text-sm leading-relaxed", style: { color: C.textDim }, children: t.desc }),
            /* @__PURE__ */ jsxs(
              "div",
              {
...
const Process = () => {
  ...
  return /* @__PURE__ */ jsx("section", { id: "processo", className: "py-24 md:py-36 relative overflow-hidden", style: { background: C.bg2 }, children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-5 md:px-8", children: [
    /* @__PURE__ */ jsx(
      SectionHead,
      {
        ...
        title: /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsx("span", { style: { color: C.accent }, children: "componente finito" })
        ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-4 relative", children: steps.map((s, i) => /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold mb-2 text-center lg:text-left", style: { color: C.text }, children: s.t }),
            /* @__PURE__ */ jsx("p", { className: "text-sm leading-relaxed text-center lg:text-left", style: { color: C.textDim }, children: s.d })
          ]
        },
        s.n
      )) })
...
const Realizations = () => {
  ...
  return /* @__PURE__ */ jsx("section", { id: "realizzazioni", className: "py-24 md:py-36", style: { background: C.bg }, children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-5 md:px-8", children: [
    /* @__PURE__ */ jsx(
      SectionHead,
      {
        kicker: "Produzione",
        title: /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsx("span", { style: { color: C.accent }, children: "l'industria italiana" })
        ] }),
    ...
    /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 gap-5 md:gap-6", children: items.map((it, i) => /* @__PURE__ */ jsxs(
      motion.article,
      {
        initial: { opacity: 0, y: 24 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 p-6 md:p-8 flex flex-col justify-end", children: [
            /* @__PURE__ */ jsx("span", { className: "text-[11px] font-semibold uppercase tracking-[0.2em] mb-2", style: { color: C.accent }, children: it.cat }),
            /* @__PURE__ */ jsx("h3", { className: "text-xl md:text-2xl font-semibold leading-snug", style: { color: C.text }, children: it.title })
          ] })
        ]
      },
      it.title
...
const CtaBanner = () => /* @__PURE__ */ jsxs("section", { className: "py-20 md:py-28 relative overflow-hidden", children: [
  /* @__PURE__ */ jsxs("div", { className: "absolute inset-0", children: [
    /* @__PURE__ */ jsx(
      "img",
      {
  ...
  /* @__PURE__ */ jsxs("div", { className: "relative max-w-4xl mx-auto px-5 md:px-8 text-center", children: [
    /* @__PURE__ */ jsx(Layers, { className: "w-10 h-10 mx-auto mb-6", style: { color: C.accent } }),
    /* @__PURE__ */ jsx("h2", { className: "text-3xl md:text-5xl font-bold leading-tight mb-5 tracking-tight", style: { color: C.text }, children: "Hai un progetto industriale da sviluppare?" }),
    /* @__PURE__ */ jsx("p", { className: "text-base md:text-lg max-w-2xl mx-auto mb-9", style: { color: C.textDim }, children: "Realizziamo lavorazioni metalliche ad alta precisione per aziende, progettisti e industria manifatturiera. Inviateci il vostro disegno: vi ricontattiamo con un'analisi tecnica." }),
    /* @__PURE__ */ jsxs(
      "button",
      {
        onClick: scrollToContact,
...
const DemoContactForm = () => {
  ...
  return /* @__PURE__ */ jsxs("form", { ref: formRef, onSubmit, noValidate: true, className: "space-y-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: labelCls, style: { color: C.textDim }, children: "Nome *" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            "data-field": "name",
        ...
        errors.name && /* @__PURE__ */ jsx("span", { className: "text-xs mt-1 block", style: { color: "#f87171" }, children: errors.name })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: labelCls, style: { color: C.textDim }, children: "Azienda" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            name: "company",
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: labelCls, style: { color: C.textDim }, children: "Email *" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            "data-field": "email",
        ...
        errors.email && /* @__PURE__ */ jsx("span", { className: "text-xs mt-1 block", style: { color: "#f87171" }, children: errors.email })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: labelCls, style: { color: C.textDim }, children: "Telefono *" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            "data-field": "phone",
        ...
        errors.phone && /* @__PURE__ */ jsx("span", { className: "text-xs mt-1 block", style: { color: "#f87171" }, children: errors.phone })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("label", { className: labelCls, style: { color: C.textDim }, children: "Messaggio" }),
      /* @__PURE__ */ jsx(
        "textarea",
        {
          name: "message",
    ...
    /* @__PURE__ */ jsxs("p", { className: "text-[11px] leading-relaxed mt-3", style: { color: C.textDim }, children: [
      ...
      " ",
      /* @__PURE__ */ jsx(Link, { to: "/privacy", target: "_blank", className: "underline", style: { color: C.text }, children: "Privacy Policy" }),
      "."
    ] })
  ] });
};
const Contacts = () => /* @__PURE__ */ jsx("section", { id: "contatti", className: "py-24 md:py-36 relative", style: { background: C.bg2 }, children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-5 md:px-8", children: [
  /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "text-xs font-bold uppercase tracking-[0.2em] mb-1", style: { color: C.accent }, children: "Avviso importante — Tech Demo" }),
          /* @__PURE__ */ jsxs("p", { className: "text-sm md:text-[15px] leading-relaxed", style: { color: C.text }, children: [
            "Questa è una ",
            /* @__PURE__ */ jsx("strong", { children: "demo tecnica realizzata da 4 Web Lab" }),
            ". Le richieste inviate tramite questo form verranno recapitate ",
            /* @__PURE__ */ jsx("strong", { children: "direttamente a 4 Web Lab" }),
            " e ",
            /* @__PURE__ */ jsx("strong", { children: "NON all'azienda" }),
  ...
  /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-[1.1fr_0.9fr] gap-10 lg:gap-14", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(
        SectionHead,
        {
          ...
          title: /* @__PURE__ */ jsxs(Fragment, { children: [
            "Parlaci del tuo ",
            /* @__PURE__ */ jsx("span", { style: { color: C.accent }, children: "progetto" })
          ] }),
      ...
      /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsx(DemoContactForm, {})
        }
      )
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "lg:pt-2", children: [
      ...
      /* @__PURE__ */ jsx("h2", { className: "text-2xl md:text-3xl font-bold leading-tight mb-4 tracking-tight", style: { color: C.text }, children: "Vuoi una demo simile per la tua azienda?" }),
      /* @__PURE__ */ jsx("p", { className: "text-[15px] leading-relaxed mb-8", style: { color: C.textDim }, children: "Questa pagina è un esempio concreto di come potrebbe essere il sito della tua impresa. Contattaci direttamente per una valutazione gratuita del tuo progetto digitale." }),
          ...
          "a",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsx("div", { className: "text-[11px] uppercase tracking-wider", style: { color: C.textDim }, children: "Chiama ora" }),
                /* @__PURE__ */ jsx("div", { className: "font-semibold", style: { color: C.text }, children: "+39 351 465 6042" })
              ] }),
              /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4 transition-transform group-hover:translate-x-1", style: { color: C.accent } })
            ]
          }
        ),
        /* @__PURE__ */ jsxs(
          "a",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsx("div", { className: "text-[11px] uppercase tracking-wider", style: { color: C.textDim }, children: "Email diretta" }),
                /* @__PURE__ */ jsx("div", { className: "font-semibold truncate", style: { color: C.text }, children: "info@4weblab.it" })
              ] }),
              /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4 transition-transform group-hover:translate-x-1", style: { color: C.accent } })
            ]
          }
          ...
          "a",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "font-semibold", style: { color: C.text }, children: "Scrivici su WhatsApp" })
              ] }),
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-3 pt-6 border-t", style: { borderColor: C.border }, children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "font-mono font-bold text-lg", style: { color: C.text }, children: b.v }),
...
const AurumFooter = () => /* @__PURE__ */ jsx("footer", { className: "pt-16 pb-8 border-t", style: { background: C.bg, borderColor: C.border }, children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-5 md:px-8", children: [
  /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-4 gap-10 mb-12", children: [
    /* @__PURE__ */ jsxs("div", { className: "md:col-span-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5 mb-4", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "font-semibold tracking-[0.18em]", style: { color: C.text }, children: "AURUM MECCANICA" })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-sm leading-relaxed mb-5 max-w-md italic", style: { color: C.textDim }, children: `"L'architettura del metallo, la precisione del futuro."` }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-2 text-sm", style: { color: C.textDim }, children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx(MapPin, { className: "w-4 h-4 mt-0.5 flex-shrink-0", style: { color: C.accent } }),
          "Via delle Industrie 42, 25030 Erbusco (BS) — Italy"
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx(Phone, { className: "w-4 h-4 mt-0.5 flex-shrink-0", style: { color: C.accent } }),
          "+39 030 1234567"
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx(Mail, { className: "w-4 h-4 mt-0.5 flex-shrink-0", style: { color: C.accent } }),
          "info@aurum-meccanica.it"
        ] }),
        /* @__PURE__ */ jsx("div", { className: "text-xs mt-3 opacity-70", children: "P.IVA 09876543210" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("h4", { className: "text-xs font-semibold uppercase tracking-[0.2em] mb-4", style: { color: C.text }, children: "Navigazione" }),
      /* @__PURE__ */ jsx("ul", { className: "space-y-2 text-sm", children: navItems.map((it) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(
        "a",
        {
          href: it.href,
          onClick: (e) => {
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("h4", { className: "text-xs font-semibold uppercase tracking-[0.2em] mb-4", style: { color: C.text }, children: "Seguici" }),
      /* @__PURE__ */ jsx("div", { className: "flex gap-2", children: ["LinkedIn", "Instagram", "YouTube"].map((s) => /* @__PURE__ */ jsx(
        "a",
        {
          href: "#",
          "aria-label": s,
  ...
  /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("strong", { style: { color: C.text }, children: "Nota:" }),
  ...
  /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { children: "© 2026 AURUM Meccanica S.r.l. (demo) — Tutti i diritti riservati." }),
        /* @__PURE__ */ jsxs("div", { children: [
          "Tech demo by",
          " ",
...
const DemoMetalmeccanica = () => {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(W, { children: [
      /* @__PURE__ */ jsx("title", { children: "Sito Web per Azienda Metalmeccanica · Demo | 4 Web Lab" }),
      /* @__PURE__ */ jsx("meta", { name: "description", content: "Demo di sito web per aziende metalmeccaniche e carpenteria, realizzata da 4 Web Lab, agenzia web di Padova. Pacchetto una tantum da 899€." }),
      /* @__PURE__ */ jsx("meta", { name: "author", content: "4 Web Lab" }),
      /* @__PURE__ */ jsx("meta", { name: "robots", content: "index, follow" }),
      /* @__PURE__ */ jsx("link", { rel: "canonical", href: "https://4weblab.it/realizzazioni/demo-metalmeccanica" }),
      ...
      /* @__PURE__ */ jsx("meta", { property: "og:url", content: "https://4weblab.it/realizzazioni/demo-metalmeccanica" }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: "Sito Web per Azienda Metalmeccanica · Demo | 4 Web Lab" }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: "Demo di sito web per aziende metalmeccaniche e carpenteria industriale · 4 Web Lab, agenzia web di Padova. Da 899€." }),
      /* @__PURE__ */ jsx("meta", { property: "og:locale", content: "it_IT" }),
      /* @__PURE__ */ jsx("meta", { property: "og:site_name", content: "4 Web Lab" }),
      /* @__PURE__ */ jsx("meta", { property: "og:image", content: "https://4weblab.it/og/demo-metalmeccanica.webp" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:card", content: "summary_large_image" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:title", content: "Sito Web per Azienda Metalmeccanica · Demo | 4 Web Lab" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:description", content: "Demo di sito web per aziende metalmeccaniche · 4 Web Lab, agenzia web di Padova. Da 899€." }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:image", content: "https://4weblab.it/og/demo-metalmeccanica.webp" }),
      /* @__PURE__ */ jsx("meta", { name: "theme-color", content: "#1A1A1B" }),
    ...
    /* @__PURE__ */ jsxs("div", { style: { background: C.bg, color: C.text, fontFamily: "'Inter', system-ui, -apple-system, Segoe UI, sans-serif" }, children: [
      /* @__PURE__ */ jsx(AurumHeader, {}),
      /* @__PURE__ */ jsxs("main", { children: [
        ...
        /* @__PURE__ */ jsx(Realizations, {}),
        /* @__PURE__ */ jsx(CtaBanner, {}),
        /* @__PURE__ */ jsx(Contacts, {})
      ] }),
      /* @__PURE__ */ jsx(AurumFooter, {})
    ] })
  ] });
};
export {
