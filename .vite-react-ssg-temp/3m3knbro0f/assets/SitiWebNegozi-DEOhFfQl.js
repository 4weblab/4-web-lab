...
const SitiWebNegozi = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Helmet, { children: [
      /* @__PURE__ */ jsx("title", { children: "Siti Web per Negozi a Padova e in Italia | 4 Web Lab" }),
      /* @__PURE__ */ jsx(
        "meta",
        {
          name: "description",
      ...
      /* @__PURE__ */ jsx("link", { rel: "canonical", href: "https://4weblab.it/siti-web-per-negozi" }),
      ...
      /* @__PURE__ */ jsx("meta", { property: "og:url", content: "https://4weblab.it/siti-web-per-negozi" }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: "Siti Web per Negozi a Padova e in Italia | 4 Web Lab" }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: "Siti web per negozi a Padova da 199€ una tantum: design moderno, SEO locale e assistenza. Attira clienti da Google. Preventivo gratuito in 24h." }),
      ...
      /* @__PURE__ */ jsx("meta", { name: "twitter:url", content: "https://4weblab.it/siti-web-per-negozi" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:title", content: "Siti Web per Negozi a Padova e in Italia | 4 Web Lab" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:description", content: "Siti web per negozi a Padova da 199€ una tantum: design moderno, SEO locale e assistenza. Attira clienti da Google. Preventivo gratuito in 24h." }),
    ...
    /* @__PURE__ */ jsxs("main", { id: "main-content", className: "pt-[calc(var(--header-height)+var(--notification-bar-height))]", children: [
      /* @__PURE__ */ jsx("section", { className: "page-hero", children: /* @__PURE__ */ jsx("div", { className: "container-section relative z-10", children: /* @__PURE__ */ jsxs(AnimatedSection, { className: "max-w-4xl mx-auto text-center", children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "heading-1 mb-8 font-extrabold tracking-tight text-primary-foreground", children: "Siti Web per Negozi a Padova (e in tutta Italia)" }),
        /* @__PURE__ */ jsx("p", { className: "body-large text-primary-foreground/80 mb-6 max-w-2xl mx-auto text-balance", children: "Realizziamo siti web professionali per negozi fisici e attività locali, pensati per portarti nuovi clienti da Google e trasformare chi ti trova online in visite reali in negozio." }),
        /* @__PURE__ */ jsx("div", { className: "inline-flex items-center gap-2 text-accent font-semibold bg-accent/10 px-6 py-3 rounded-full mb-8", children: /* @__PURE__ */ jsx("span", { children: "Siti web per negozi a partire da 199€" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-xs text-primary-foreground/50 mt-3", children: "Risposta entro 24h – senza impegno" })
        ] })
      ] }) }) }),
      /* @__PURE__ */ jsx("section", { className: "section-padding bg-background", children: /* @__PURE__ */ jsx("div", { className: "container-section", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxs(AnimatedSection, { className: "flex items-center gap-4 mb-10", children: [
          /* @__PURE__ */ jsx("div", { className: "icon-box w-13 h-13", children: /* @__PURE__ */ jsx(Store, { className: "w-6 h-6 text-accent-foreground" }) }),
          /* @__PURE__ */ jsx("h2", { className: "heading-2", children: "Perché oggi un negozio senza sito web perde clienti ogni giorno" })
        ] }),
        /* @__PURE__ */ jsx(AnimatedSection, { className: "prose prose-lg max-w-none text-muted-foreground mb-8", delay: 0.1, children: /* @__PURE__ */ jsxs("p", { children: [
          ...
          " ",
          /* @__PURE__ */ jsx(Link, { to: "/blog/perche-il-tuo-sito-non-si-trova-su-google", className: "text-accent hover:underline font-medium", children: "perché il tuo sito non si trova su Google" }),
          "."
        ] }) }),
        /* @__PURE__ */ jsx(StaggerContainer, { className: "grid md:grid-cols-2 gap-6", staggerDelay: 0.1, children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "icon-box w-12 h-12 rounded-2xl mb-4", children: /* @__PURE__ */ jsx(item.icon, { className: "w-6 h-6 text-accent-foreground", "aria-hidden": "true" }) }),
      ...
      /* @__PURE__ */ jsx("section", { className: "section-padding", style: { background: "var(--gradient-surface)" }, children: /* @__PURE__ */ jsx("div", { className: "container-section", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxs(AnimatedSection, { className: "flex items-center gap-4 mb-10", children: [
          ...
          /* @__PURE__ */ jsx("h2", { className: "heading-2", children: "Cosa realizziamo per il tuo negozio" })
        ] }),
        /* @__PURE__ */ jsx(AnimatedSection, { className: "prose prose-lg max-w-none text-muted-foreground mb-10", delay: 0.1, children: /* @__PURE__ */ jsx("p", { children: "Non creiamo semplici siti vetrina, ma strumenti pensati per aiutarti a portare clienti reali nel tuo punto vendita." }) }),
        /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-center", children: [
          ...
          /* @__PURE__ */ jsx(AnimatedSection, { direction: "right", children: /* @__PURE__ */ jsx(StaggerContainer, { className: "space-y-3", staggerDelay: 0.08, children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "section-padding bg-background", children: /* @__PURE__ */ jsx("div", { className: "container-section", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxs(AnimatedSection, { className: "flex items-center gap-4 mb-10", children: [
          ...
          /* @__PURE__ */ jsx("h2", { className: "heading-2", children: "Siti web progettati per negozi locali" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-center", children: [
          /* @__PURE__ */ jsxs(AnimatedSection, { className: "prose prose-lg max-w-none text-muted-foreground order-2 md:order-1", direction: "left", children: [
            /* @__PURE__ */ jsxs("p", { className: "mb-8", children: [
              ...
              " ",
              /* @__PURE__ */ jsx(Link, { to: "/realizzazione-siti-web-padova", className: "text-accent hover:underline font-medium", children: "negozi della provincia di Padova" }),
              " ",
              ...
              /* @__PURE__ */ jsx(Link, { to: "/pubblicita-google-ads", className: "text-accent hover:underline font-medium", children: "campagne Google ADS mirate sulla tua zona" }),
              "."
            ] }),
            /* @__PURE__ */ jsx(StaggerContainer, { className: "space-y-4", staggerDelay: 0.1, children: [
            ...
            ].map((item, index) => /* @__PURE__ */ jsx(StaggerItem, { children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 p-5 rounded-2xl bg-accent/3 border border-accent/8 transition-all duration-400 hover:bg-accent/6 hover:border-accent/15", children: [
              /* @__PURE__ */ jsx("div", { className: "icon-box w-10 h-10 rounded-xl flex-shrink-0", children: /* @__PURE__ */ jsx(item.icon, { className: "w-5 h-5 text-accent-foreground", "aria-hidden": "true" }) }),
              /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground", children: item.text })
            ] }) }, index)) })
          ] }),
          /* @__PURE__ */ jsx(AnimatedSection, { className: "order-1 md:order-2", direction: "right", children: /* @__PURE__ */ jsx(
            "img",
            {
              src: mobileSearchImg,
      ...
      /* @__PURE__ */ jsx("section", { className: "section-padding", style: { background: "var(--gradient-surface)" }, children: /* @__PURE__ */ jsx("div", { className: "container-section", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxs(AnimatedSection, { className: "flex items-center gap-4 mb-10", children: [
          /* @__PURE__ */ jsx("div", { className: "icon-box w-13 h-13", children: /* @__PURE__ */ jsx(Eye, { className: "w-6 h-6 text-accent-foreground" }) }),
          /* @__PURE__ */ jsx("h2", { className: "heading-2", children: "Cosa ottieni con un sito web per il tuo negozio" })
        ] }),
        /* @__PURE__ */ jsx(StaggerContainer, { className: "grid md:grid-cols-3 gap-8", staggerDelay: 0.1, children: [
          {
            icon: Users,
          ...
          /* @__PURE__ */ jsx("div", { className: "icon-box w-16 h-16 mx-auto mb-5", children: /* @__PURE__ */ jsx(item.icon, { className: "w-7 h-7 text-accent-foreground", "aria-hidden": "true" }) }),
      ...
      /* @__PURE__ */ jsx("section", { className: "section-padding bg-background", children: /* @__PURE__ */ jsx("div", { className: "container-section", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto", children: [
        /* @__PURE__ */ jsxs(AnimatedSection, { className: "flex items-center gap-4 mb-10", children: [
          ...
          /* @__PURE__ */ jsx("h2", { className: "heading-2", children: "Quanto costa un sito web per negozi" })
        ] }),
        /* @__PURE__ */ jsx(AnimatedSection, { delay: 0.1, children: /* @__PURE__ */ jsxs("div", { className: "card-glass p-10 relative overflow-hidden", style: { border: "1px solid hsl(210 30% 88%)", boxShadow: "0 8px 32px -4px hsl(210 73% 15% / 0.12), 0 2px 8px -2px hsl(210 73% 15% / 0.07)" }, children: [
          /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 px-5 py-1.5 rounded-bl-2xl text-xs font-bold tracking-wide", style: { background: "var(--gradient-accent)", color: "white" }, children: "SITO COMPLETO" }),
          /* @__PURE__ */ jsxs("div", { className: "text-center mb-10", children: [
            /* @__PURE__ */ jsx("span", { className: "text-sm text-muted-foreground block mb-2", children: "a partire da" }),
            /* @__PURE__ */ jsx("span", { className: "text-5xl md:text-6xl font-serif font-bold text-foreground", children: "€199" }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm mt-2", children: "IVA esclusa" })
          ] }),
          /* @__PURE__ */ jsx("ul", { className: "space-y-4 mb-10 max-w-md mx-auto", role: "list", children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "text-xs text-muted-foreground text-center mb-6", children: [
            "Il prezzo varia in base alle esigenze.",
            " ",
            /* @__PURE__ */ jsx(Link, { to: "/blog/quanto-costa-un-sito-web-nel-2026", className: "text-accent hover:underline font-medium", children: "Scopri come si calcola il costo di un sito nel 2026" }),
            "."
          ] }),
      ...
      /* @__PURE__ */ jsx("section", { className: "section-padding", style: { background: "var(--gradient-surface)" }, children: /* @__PURE__ */ jsx("div", { className: "container-section", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto", children: [
        /* @__PURE__ */ jsxs(AnimatedSection, { className: "flex items-center gap-4 mb-10", children: [
          ...
          /* @__PURE__ */ jsx("h2", { className: "heading-2", children: "Domande frequenti sui siti web per negozi" })
        ] }),
        /* @__PURE__ */ jsx(AnimatedSection, { delay: 0.1, children: /* @__PURE__ */ jsx(Accordion, { type: "single", collapsible: true, className: "space-y-3", children: [
        ...
        ].map((faq, index) => /* @__PURE__ */ jsxs(AccordionItem, { value: `faq-${index}`, className: "rounded-2xl border border-border bg-accent/3 px-6 transition-all duration-300 hover:border-accent/15 hover:bg-accent/6", children: [
          ...
          /* @__PURE__ */ jsx(AccordionContent, { className: "text-muted-foreground text-sm leading-relaxed pb-5", children: faq.answer })
        ] }, index)) }) })
      ] }) }) }),
      /* @__PURE__ */ jsx("section", { className: "section-padding bg-background", children: /* @__PURE__ */ jsx("div", { className: "container-section", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxs(AnimatedSection, { className: "flex items-center gap-4 mb-10", children: [
        ...
        /* @__PURE__ */ jsx(StaggerContainer, { className: "space-y-5", staggerDelay: 0.1, children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "section-padding", style: { background: "var(--gradient-surface)" }, children: /* @__PURE__ */ jsx("div", { className: "container-section", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsx(AnimatedSection, { delay: 0.2, children: /* @__PURE__ */ jsxs("div", { className: "mt-8 space-y-4", children: [
          /* @__PURE__ */ jsx(Link, { to: "/siti-web-aziendali", className: "block p-5 rounded-2xl border border-border/60 bg-white hover:border-accent/30 hover:shadow-md transition-all duration-300 group", children: /* @__PURE__ */ jsx("span", { className: "text-lg font-semibold text-foreground group-hover:text-accent transition-colors", children: "Ho bisogno di un sito web per la mia azienda →" }) }),
          /* @__PURE__ */ jsx(Link, { to: "/siti-web-per-professionisti", className: "block p-5 rounded-2xl border border-border/60 bg-white hover:border-accent/30 hover:shadow-md transition-all duration-300 group", children: /* @__PURE__ */ jsx("span", { className: "text-lg font-semibold text-foreground group-hover:text-accent transition-colors", children: "Cerco un sito per la mia attività professionale →" }) })
        ] }) })
      ] }) }) }),
      /* @__PURE__ */ jsxs("section", { id: "contatti-negozi", className: "section-padding relative overflow-hidden", style: { background: "var(--gradient-hero)" }, children: [
        /* @__PURE__ */ jsx("div", { className: "noise-overlay", "aria-hidden": "true", children: /* @__PURE__ */ jsxs("svg", { width: "100%", height: "100%", xmlns: "http://www.w3.org/2000/svg", children: [
          /* @__PURE__ */ jsx("filter", { id: "negozi-cta-noise", children: /* @__PURE__ */ jsx("feTurbulence", { type: "fractalNoise", baseFrequency: "0.65", numOctaves: "3", stitchTiles: "stitch" }) }),
          /* @__PURE__ */ jsx("rect", { width: "100%", height: "100%", filter: "url(#negozi-cta-noise)" })
        ] }) }),
        /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 right-1/3 w-96 h-96 rounded-full bg-accent/8 blur-[120px]", "aria-hidden": "true" }),
        /* @__PURE__ */ jsx("div", { className: "container-section relative z-10", children: /* @__PURE__ */ jsxs(AnimatedSection, { className: "grid md:grid-cols-2 gap-8 items-stretch", children: [
          /* @__PURE__ */ jsxs("div", { className: "bg-primary-foreground/5 border border-primary-foreground/10 rounded-2xl p-8 flex flex-col justify-center", children: [
            /* @__PURE__ */ jsx("h2", { className: "heading-2 text-primary-foreground mb-6", children: "Richiedi un preventivo per il tuo sito web" }),
            /* @__PURE__ */ jsx("p", { className: "body-large text-primary-foreground/70 mb-8", children: "Raccontaci il tuo negozio e ti proponiamo la soluzione più adatta, senza impegno." }),
