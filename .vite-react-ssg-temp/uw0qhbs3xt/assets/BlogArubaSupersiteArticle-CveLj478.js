  ...
  },
  {
    ...
    paragraphs: [
      ...
      /* @__PURE__ */ jsxDEV(Fragment, { children: [
        ...
        " ",
        /* @__PURE__ */ jsxDEV(Link, { to: "/blog/creare-sito-web-da-soli-conviene", className: linkClass, children: "nella guida dedicata al fai-da-te" }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
          lineNumber: 48,
          columnNumber: 9
        }, void 0),
        "."
  ...
  },
  {
    ...
    paragraphs: [
      ...
      /* @__PURE__ */ jsxDEV(Fragment, { children: [
        ...
        " ",
        /* @__PURE__ */ jsxDEV(Link, { to: "/blog/perche-il-tuo-sito-non-si-trova-su-google", className: linkClass, children: "abbiamo dedicato una guida intera al perché un sito non compare su Google" }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
          lineNumber: 72,
          columnNumber: 9
        }, void 0),
      ...
      /* @__PURE__ */ jsxDEV(Fragment, { children: [
        ...
        " ",
        /* @__PURE__ */ jsxDEV(Link, { to: "/pubblicita-google-ads", className: linkClass, children: "pubblicità su Google ADS gestita da chi conosce il tuo settore" }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
          lineNumber: 79,
          columnNumber: 9
        }, void 0),
  ...
  },
  {
    ...
    paragraphs: [
      ...
      /* @__PURE__ */ jsxDEV(Fragment, { children: [
        ...
        " ",
        /* @__PURE__ */ jsxDEV(Link, { to: "/blog/siti-web-piattaforme-preventivi-online-conviene", className: linkClass, children: "con le piattaforme di preventivi online" }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
          lineNumber: 102,
          columnNumber: 9
        }, void 0),
  ...
  },
  {
    ...
    paragraphs: [
      ...
      /* @__PURE__ */ jsxDEV(Fragment, { children: [
        ...
        " ",
        /* @__PURE__ */ jsxDEV(Link, { to: "/blog/quanto-costa-un-sito-web-nel-2026", className: linkClass, children: "capire quanto costa davvero un sito web fatto bene" }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
          lineNumber: 116,
          columnNumber: 9
        }, void 0),
  ...
  return /* @__PURE__ */ jsxDEV(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxDEV("main", { id: "main-content", children: [
      /* @__PURE__ */ jsxDEV("section", { className: "page-hero", children: [
        /* @__PURE__ */ jsxDEV("div", { "aria-hidden": "true", className: "pointer-events-none absolute -top-24 right-0 h-72 w-72 rounded-full bg-accent/10 blur-[120px]" }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
          lineNumber: 239,
          columnNumber: 11
        }, void 0),
        /* @__PURE__ */ jsxDEV("div", { "aria-hidden": "true", className: "pointer-events-none absolute bottom-0 left-1/4 h-56 w-56 rounded-full bg-primary-foreground/10 blur-[110px]" }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
          lineNumber: 240,
          columnNumber: 11
        }, void 0),
        /* @__PURE__ */ jsxDEV("div", { className: "container-section relative z-10", children: /* @__PURE__ */ jsxDEV(AnimatedSection, { className: "mx-auto max-w-4xl text-center", children: [
          ...
          /* @__PURE__ */ jsxDEV("h1", { className: "heading-1 mt-6 text-primary-foreground text-balance", children: "Aruba SuperSite conviene davvero? Limiti, tempo perso e cosa sapere prima di creare il tuo sito" }, void 0, false, {
            fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
            lineNumber: 253,
            columnNumber: 15
          }, void 0),
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "article-intro-section", children: /* @__PURE__ */ jsxDEV("div", { className: "container-section", children: /* @__PURE__ */ jsxDEV(AnimatedSection, { className: "mx-auto max-w-3xl", children: /* @__PURE__ */ jsxDEV("div", { className: "rounded-[2rem] border border-border/60 bg-card px-6 py-8 shadow-sm md:px-10 md:py-12", children: /* @__PURE__ */ jsxDEV("div", { className: "space-y-6 text-base leading-8 text-foreground md:text-lg", children: introParagraphs.map((paragraph, index) => /* @__PURE__ */ jsxDEV("p", { className: index === 3 ? "font-semibold text-foreground" : "text-foreground/90", children: paragraph }, index, false, {
        fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
        lineNumber: 283,
        columnNumber: 21
      }, void 0)) }, void 0, false, {
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "article-body-section", style: { background: "var(--gradient-surface)" }, children: /* @__PURE__ */ jsxDEV("div", { className: "container-section", children: /* @__PURE__ */ jsxDEV("div", { className: "mx-auto flex max-w-3xl flex-col gap-6 md:gap-8", children: [
        sections.map((section, index) => /* @__PURE__ */ jsxDEV(AnimatedSection, { delay: index * 0.04, children: /* @__PURE__ */ jsxDEV("article", { className: "rounded-[2rem] border border-border/60 bg-card px-6 py-8 shadow-sm md:px-10 md:py-10", children: [
        ...
        /* @__PURE__ */ jsxDEV(AnimatedSection, { delay: sections.length * 0.04, children: /* @__PURE__ */ jsxDEV("article", { className: "rounded-[2rem] border border-border/60 bg-card px-6 py-8 shadow-sm md:px-10 md:py-10", children: [
          /* @__PURE__ */ jsxDEV("div", { className: "mb-6 h-1 w-14 rounded-full bg-accent" }, void 0, false, {
            fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
            lineNumber: 313,
            columnNumber: 19
          }, void 0),
          /* @__PURE__ */ jsxDEV("h2", { className: "heading-3 text-foreground", children: "Esempi di siti realizzati con piattaforme fai-da-te" }, void 0, false, {
            fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
            lineNumber: 314,
            columnNumber: 19
          }, void 0),
          /* @__PURE__ */ jsxDEV("p", { className: "mt-6 text-base leading-8 text-foreground/90 md:text-lg", children: "Per rendere il discorso più concreto, ecco due esempi reali di siti web realizzati con piattaforme fai-da-te. Clicca su un'immagine per ingrandirla a schermo intero." }, void 0, false, {
            fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
            lineNumber: 315,
            columnNumber: 19
          }, void 0),
          /* @__PURE__ */ jsxDEV("div", { className: "mt-8 grid grid-cols-1 gap-5 md:grid-cols-2", children: examples.map((ex, i) => /* @__PURE__ */ jsxDEV(
            "button",
            {
              type: "button",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxDEV("span", { className: "pointer-events-none absolute right-3 top-3 inline-flex items-center gap-1 rounded-full bg-background/90 px-2.5 py-1 text-xs font-semibold text-foreground shadow-sm backdrop-blur", children: [
                  /* @__PURE__ */ jsxDEV(ZoomIn, { className: "h-3.5 w-3.5", "aria-hidden": "true" }, void 0, false, {
                    fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
                    lineNumber: 337,
                    columnNumber: 27
                  }, void 0),
                ...
                /* @__PURE__ */ jsxDEV("span", { className: "block px-4 py-3 text-xs text-muted-foreground md:text-sm", children: ex.caption }, void 0, false, {
                  fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
                  lineNumber: 340,
                  columnNumber: 25
                }, void 0)
      ...
      /* @__PURE__ */ jsxDEV(RelatedArticles, { currentSlug: "aruba-supersite-conviene-davvero-limiti-e-cosa-sapere" }, void 0, false, {
        fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
        lineNumber: 352,
        columnNumber: 9
      }, void 0),
      /* @__PURE__ */ jsxDEV("section", { className: "section-padding bg-background", children: /* @__PURE__ */ jsxDEV("div", { className: "container-section", children: /* @__PURE__ */ jsxDEV(AnimatedSection, { className: "mx-auto max-w-3xl rounded-[2rem] border border-border/60 bg-card px-6 py-8 text-center shadow-sm md:px-10 md:py-12", children: [
        ...
        /* @__PURE__ */ jsxDEV("h2", { className: "heading-2 text-foreground", children: "Stai valutando Aruba SuperSite o un'alternativa professionale?" }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
          lineNumber: 358,
          columnNumber: 15
        }, void 0),
        /* @__PURE__ */ jsxDEV("p", { className: "body-large mt-5 text-muted-foreground", children: "Raccontaci cosa fai e ti aiutiamo a capire qual è la soluzione più efficace per la tua attività, senza tecnicismi e senza impegno." }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
          lineNumber: 359,
          columnNumber: 15
        }, void 0),
        ...
        children: [
          /* @__PURE__ */ jsxDEV(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxDEV(X, { className: "h-6 w-6", "aria-hidden": "true" }, void 0, false, {
                fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
                lineNumber: 390,
                columnNumber: 13
              }, void 0)
          ...
          /* @__PURE__ */ jsxDEV(
            "figure",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxDEV("figcaption", { className: "max-w-2xl text-center text-sm text-foreground/80 md:text-base", children: active.caption }, void 0, false, {
                  fileName: "/dev-server/src/pages/BlogArubaSupersiteArticle.tsx",
                  lineNumber: 401,
                  columnNumber: 13
                }, void 0)
