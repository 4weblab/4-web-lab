  ...
  },
  {
    ...
    paragraphs: [
      ...
      /* @__PURE__ */ jsxDEV(Fragment, { children: [
        ...
        " ",
        /* @__PURE__ */ jsxDEV(Link, { to: "/blog/quanto-costa-un-sito-web-nel-2026", className: linkClass, children: "i prezzi reali di un sito professionale nel 2026" }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogAiWebsiteArticle.tsx",
          lineNumber: 49,
          columnNumber: 9
        }, void 0),
  ...
  },
  {
    ...
    paragraphs: [
      ...
      /* @__PURE__ */ jsxDEV(Fragment, { children: [
        ...
        " ",
        /* @__PURE__ */ jsxDEV(Link, { to: "/blog/perche-il-tuo-sito-non-si-trova-su-google", className: linkClass, children: "molti siti non riescono a comparire su Google" }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogAiWebsiteArticle.tsx",
          lineNumber: 102,
          columnNumber: 9
        }, void 0),
    ...
    /* @__PURE__ */ jsxDEV("main", { id: "main-content", children: [
      /* @__PURE__ */ jsxDEV("section", { className: "page-hero", children: [
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "container-section relative z-10", children: /* @__PURE__ */ jsxDEV(AnimatedSection, { className: "mx-auto max-w-4xl text-center", children: [
          ...
          /* @__PURE__ */ jsxDEV("h1", { className: "heading-1 mt-6 text-primary-foreground text-balance", children: "Siti web creati con intelligenza artificiale: opportunità reale o rischio per le aziende?" }, void 0, false, {
            fileName: "/dev-server/src/pages/BlogAiWebsiteArticle.tsx",
            lineNumber: 233,
            columnNumber: 15
          }, void 0),
      ...
      /* @__PURE__ */ jsxDEV("section", { className: "article-body-section", style: { background: "var(--gradient-surface)" }, children: /* @__PURE__ */ jsxDEV("div", { className: "container-section", children: /* @__PURE__ */ jsxDEV("div", { className: "mx-auto flex max-w-3xl flex-col gap-6 md:gap-8", children: sections.map((section, index) => {
        ...
        return /* @__PURE__ */ jsxDEV(AnimatedSection, { delay: index * 0.04, children: /* @__PURE__ */ jsxDEV("article", { className: "rounded-[2rem] border border-border/60 bg-card px-6 py-8 shadow-sm md:px-10 md:py-10", children: [
          ...
          /* @__PURE__ */ jsxDEV("div", { className: "mt-6 space-y-5 text-base leading-8 text-foreground/90 md:text-lg", children: (_a = section.paragraphs) == null ? void 0 : _a.map((paragraph, pIndex) => /* @__PURE__ */ jsxDEV("p", { children: paragraph }, pIndex, false, {
            fileName: "/dev-server/src/pages/BlogAiWebsiteArticle.tsx",
            lineNumber: 286,
            columnNumber: 25
          }, void 0)) }, void 0, false, {
          ...
          section.subSections ? /* @__PURE__ */ jsxDEV("div", { className: "mt-8 space-y-6 border-t border-border/50 pt-8", children: section.subSections.map((subSection) => /* @__PURE__ */ jsxDEV("div", { className: "rounded-2xl bg-muted/35 p-5 md:p-6", children: [
            ...
            /* @__PURE__ */ jsxDEV("div", { className: "mt-3 space-y-4 text-base leading-8 text-foreground/85 md:text-lg", children: subSection.paragraphs.map((paragraph) => /* @__PURE__ */ jsxDEV("p", { children: paragraph }, paragraph, false, {
              fileName: "/dev-server/src/pages/BlogAiWebsiteArticle.tsx",
              lineNumber: 296,
              columnNumber: 73
            }, void 0)) }, void 0, false, {
      ...
      /* @__PURE__ */ jsxDEV(RelatedArticles, { currentSlug: "siti-web-creati-con-intelligenza-artificiale" }, void 0, false, {
        fileName: "/dev-server/src/pages/BlogAiWebsiteArticle.tsx",
        lineNumber: 309,
        columnNumber: 9
      }, void 0),
      /* @__PURE__ */ jsxDEV("section", { className: "section-padding bg-background", children: /* @__PURE__ */ jsxDEV("div", { className: "container-section", children: /* @__PURE__ */ jsxDEV(AnimatedSection, { className: "mx-auto max-w-3xl rounded-[2rem] border border-border/60 bg-card px-6 py-8 text-center shadow-sm md:px-10 md:py-12", children: [
        ...
        /* @__PURE__ */ jsxDEV("h2", { className: "heading-2 text-foreground", children: "Vuoi capire qual è la soluzione giusta per la tua attività?" }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogAiWebsiteArticle.tsx",
          lineNumber: 315,
          columnNumber: 15
        }, void 0),
        /* @__PURE__ */ jsxDEV("p", { className: "body-large mt-5 text-muted-foreground", children: "Raccontaci cosa fai e ti aiutiamo a capire se un sito base può bastare oppure se serve una struttura più efficace per ottenere risultati concreti." }, void 0, false, {
          fileName: "/dev-server/src/pages/BlogAiWebsiteArticle.tsx",
          lineNumber: 316,
          columnNumber: 15
        }, void 0),
