...
const services = [
  {
    ...
    description: 'Creazione di siti vetrina, one-page e multi-pagina per presentare al meglio la tua attività. Soluzione ideale per professionisti, negozi e aziende che operano in tutta Italia.',
    features: ['Design personalizzato', 'Responsive su tutti i dispositivi', 'Ottimizzato per la velocità'],
  },
  {
    icon: Palette,
    title: 'Restyling e rebranding',
    description: 'Rinnoviamo il tuo sito esistente con un design moderno e funzionalità aggiornate. Soluzione ideale per professionisti, negozi e aziende che operano in tutta Italia.',
    features: ['Analisi del sito attuale', 'Nuovo design su misura', 'Migrazione contenuti'],
  },
  {
    icon: BarChart3,
    title: 'SEO e visibilità',
    description: 'Strategie di ottimizzazione per posizionarti su Google e farti trovare dai clienti. Soluzione ideale per professionisti, negozi e aziende che operano in tutta Italia.',
    features: ['Ricerca parole chiave', 'Ottimizzazione on-page', 'Google Business Profile'],
  },
  {
    icon: Wrench,
    title: 'Manutenzione e assistenza',
    description: 'Aggiornamenti, backup e supporto tecnico per mantenere il tuo sito sempre efficiente. Soluzione ideale per professionisti, negozi e aziende che operano in tutta Italia.',
    features: ['Aggiornamenti periodici', 'Backup automatici', 'Supporto prioritario'],
  },
  {
    icon: RefreshCw,
    title: 'Gestione contenuti',
    description: 'Aggiornamento testi, immagini e contenuti del tuo sito in modo rapido e professionale. Soluzione ideale per professionisti, negozi e aziende che operano in tutta Italia.',
    features: ['Modifiche rapide', 'Caricamento media', 'Nuove sezioni'],
  },
  {
    icon: MessageSquare,
    title: 'Consulenza web',
    description: 'Analisi e consigli strategici per migliorare la tua presenza digitale. Soluzione ideale per professionisti, negozi e aziende che operano in tutta Italia.',
