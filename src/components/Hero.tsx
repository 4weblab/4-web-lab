    ...
    >
      ...
      <div className="container-section relative z-10 text-center py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="body-large text-primary-foreground/80 mb-10 max-w-2xl mx-auto animate-fade-in-up text-balance" style={{ animationDelay: '0.1s' }}>
            Soluzioni web professionali per piccole imprese e PMI. Design moderno, performance elevate e strategie SEO per farti trovare dai tuoi clienti.
          </p>
