...
const faqs = [
  {
    question: "Quanto costa un sito web a Vigonza?",
    answer:
  ...
  {
    question: "Quanto tempo serve per realizzare un sito a Vigonza?",
    answer:
      "In genere 14 giorni per un sito One-Page o Vetrina, fino a 3-4 settimane per un sito aziendale più articolato.",
  },
  {
    question: "Lavorate con attività della frazione di Busa o delle altre frazioni di Vigonza?",
    answer:
      "Sì, seguiamo attività sia nella frazione di Busa, ormai quasi periferia di Padova, sia nelle altre frazioni più raccolte come Codiverno, Pionca, Peraga e San Vito.",
  },
];
