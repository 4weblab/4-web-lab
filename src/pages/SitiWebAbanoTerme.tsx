...
import vigProssimita from "@/assets/abano-terme-prossimita.webp";
...
const faqs = [
  {
    question: "Quanto costa un sito web a Abano Terme?",
    answer:
  ...
  {
    question: "Quanto tempo serve per realizzare un sito a Abano Terme?",
    answer:
      "In genere 14 giorni per un sito One-Page o Vetrina, fino a 3-4 settimane per un sito aziendale più articolato.",
  },
  {
    question: "Realizzate siti per hotel e strutture termali di Abano Terme?",
    answer:
      "Sì, è uno dei nostri ambiti più naturali: un sito veloce e ben strutturato è spesso il primo contatto con un cliente che sta pianificando un soggiorno termale da un'altra città o dall'estero, ed è per questo che curiamo con particolare attenzione le pagine di prenotazione e presentazione dei servizi.",
  },
];

const SitiWebAbanoTerme = () => {
  return (
    <>
      <Helmet>
        <title>{TITLE}</title>
      ...
      <main id="main-content">
        ...
        <section className="page-hero">
          <div className="noise-overlay" aria-hidden="true">
            <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
              <filter id="abano-terme-hero-noise">
                <feTurbulence type="fractalNoise" baseFrequency="0.65" numOctaves="3" stitchTiles="stitch" />
              </filter>
              <rect width="100%" height="100%" filter="url(#abano-terme-hero-noise)" />
            </svg>
          </div>
          ...
          <div className="container-section relative z-10 pt-16">
            <AnimatedSection className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                <button
                  onClick={() => document.getElementById("contatti-abano-terme")?.scrollIntoView({ behavior: "smooth" })}
        ...
        <section
          id="contatti-abano-terme"
          className="section-padding relative overflow-hidden"
          style={{ background: "var(--gradient-hero)", scrollMarginTop: "var(--header-height)" }}
        >
          <div className="noise-overlay" aria-hidden="true">
            <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
              <filter id="abano-terme-contact-noise">
                <feTurbulence type="fractalNoise" baseFrequency="0.65" numOctaves="3" stitchTiles="stitch" />
              </filter>
              <rect width="100%" height="100%" filter="url(#abano-terme-contact-noise)" />
            </svg>
          </div>
...
export default SitiWebAbanoTerme;
