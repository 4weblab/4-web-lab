...
const faqs = [
  {
    question: "Quanto costa un sito web a Albignasego?",
    answer:
  ...
  {
    question: "Quanto tempo serve per realizzare un sito a Albignasego?",
    answer:
      "In genere 14 giorni per un sito One-Page o Vetrina, fino a 3-4 settimane per un sito aziendale più articolato.",
  },
  {
    question: "Coprite anche i quartieri di Albignasego come San Tommaso, Carpanedo o Mandriola?",
    answer:
      "Sì, lavoriamo con attività di tutti gli otto quartieri di Albignasego, dal centro fino alle zone più periferiche verso la cintura sud di Padova.",
  },
];
