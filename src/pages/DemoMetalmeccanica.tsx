...
const DemoMetalmeccanica = () => {
  return (
    <>
      <Helmet>
        <title>Sito Web per Aziende Metalmeccaniche e Carpenterie</title>
        <meta name="description" content="Struttura web aziendale per il settore metalmeccanico: presentazione lavorazioni CNC, certificazioni e generazione contatti B2B." />
        ...
        <meta property="og:title" content="Sito Web per Aziende Metalmeccaniche e Carpenterie" />
        <meta property="og:description" content="Struttura web aziendale per il settore metalmeccanico: presentazione lavorazioni CNC, certificazioni e generazione contatti B2B." />
        <meta property="og:locale" content="it_IT" />
        <meta property="og:site_name" content="4 Web Lab" />
        <meta property="og:image" content="https://4weblab.it/og/demo-metalmeccanica.webp" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Sito Web per Aziende Metalmeccaniche e Carpenterie" />
        <meta name="twitter:description" content="Struttura web aziendale per il settore metalmeccanico: presentazione lavorazioni CNC, certificazioni e generazione contatti B2B." />
