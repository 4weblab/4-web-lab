            ...
            <AnimatedSection className="grid md:grid-cols-2 gap-8 items-stretch" delay={0.2}>
              <div className="bg-primary-foreground/5 border border-primary-foreground/10 rounded-2xl p-8 flex flex-col justify-center">
                ...
                <div className="text-center">
                  <button onClick={() => { window.location.href = '/#contatti'; }} className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-[#25D366] hover:bg-[#1ebe57] text-white font-semibold text-base shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5">
