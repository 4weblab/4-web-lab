  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Realizzazione siti web Padova: agenzia locale specializzata in siti professionali per aziende, negozi e professionisti. Da 199€ tutto incluso. SEO locale, design moderno e assistenza dedicata. Preventivo gratuito in 24h!" />
        ...
        <meta property="og:description" content="Realizzazione siti web Padova: agenzia locale specializzata in siti professionali per aziende, negozi e professionisti. Da 199€ tutto incluso. SEO locale, design moderno e assistenza dedicata. Preventivo gratuito in 24h!" />
        ...
        <meta name="twitter:description" content="Realizzazione siti web Padova: agenzia locale specializzata in siti professionali per aziende, negozi e professionisti. Da 199€ tutto incluso. SEO locale, design moderno e assistenza dedicata. Preventivo gratuito in 24h!" />
      ...
      <main id="main-content" className="pt-[var(--header-height)]">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <StaggerContainer className="space-y-6" staggerDelay={0.12}>
                {[
                {
                  ...
                  description: 'Studiamo il tuo settore, i tuoi obiettivi e il contesto competitivo per definire le fondamenta del progetto.'
                },
                {
                  step: '02',
                  title: 'Progettazione struttura',
                  description: 'Definiamo architettura delle informazioni, layout e design in linea con la tua identità e le aspettative del tuo pubblico.'
                },
                {
                  step: '03',
                  title: 'Sviluppo ottimizzato SEO',
                  description: 'Realizziamo il sito con tecnologie moderne, velocità di caricamento elevata e ottimizzazione per i motori di ricerca.'
                },
                {
                  step: '04',
                  title: 'Pubblicazione e supporto',
                  description: 'Lanciamo il sito e restiamo al tuo fianco con assistenza continuativa per aggiornamenti e miglioramenti.'
                }].
                map((item, index) =>
                <StaggerItem key={index}>
        ...
        <section id="contatti-padova" className="section-padding relative overflow-hidden" style={{ background: 'var(--gradient-hero)' }}>
          {/* Noise texture */}
          <div className="noise-overlay" aria-hidden="true">
            <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
