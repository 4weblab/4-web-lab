...
import psnProssimita from "@/assets/ponte-san-nicolo-prossimita.webp";
import psnVelocita from "@/assets/ponte-san-nicolo-velocita.webp";
import psnIa from "@/assets/ponte-san-nicolo-ia.webp";
...
const URL = "https://4weblab.it/realizzazione-siti-web-ponte-san-nicolo";
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        <section className="page-hero">
          <div className="noise-overlay" aria-hidden="true">
            <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
              <filter id="psn-hero-noise">
                <feTurbulence type="fractalNoise" baseFrequency="0.65" numOctaves="3" stitchTiles="stitch" />
              </filter>
              <rect width="100%" height="100%" filter="url(#psn-hero-noise)" />
            </svg>
          </div>
          ...
          <div className="container-section relative z-10 pt-16">
            <AnimatedSection className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                <button
                  onClick={() => document.getElementById("contatti-ponte-san-nicolo")?.scrollIntoView({ behavior: "smooth" })}
        ...
        <section
          id="contatti-ponte-san-nicolo"
          className="section-padding relative overflow-hidden"
          style={{ background: "var(--gradient-hero)", scrollMarginTop: "var(--header-height)" }}
        >
          <div className="noise-overlay" aria-hidden="true">
            <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
              <filter id="psn-contact-noise">
                <feTurbulence type="fractalNoise" baseFrequency="0.65" numOctaves="3" stitchTiles="stitch" />
              </filter>
              <rect width="100%" height="100%" filter="url(#psn-contact-noise)" />
            </svg>
          </div>
